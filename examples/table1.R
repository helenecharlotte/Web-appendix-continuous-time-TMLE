...
## Version: 
## Last-Updated: Nov 11 2020 (10:23) 
...
if (FALSE){ # be careful setting the number of cores and to watch the memory for large values of K   
    ...
    table1.K5.conTMLE <- runTMLE(no_cores=nc,K=5,misspecify.init = FALSE,M = M,n = n,max.iter=25,eps=0,seed=28,progress.bar=3)
    saveRDS(table1.K5.conTMLE,file="./examples/table1-K5-conTMLE-0.rds")
    ...
    table1.K30.conTMLE <- runTMLE(no_cores=nc,K=30,misspecify.init = FALSE,M = M,n = n,max.iter=25,eps=0.001,seed=28,progress.bar=3)
